...
const Hero = () => {
        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div
                className={`wow fadeInUp mx-auto max-w-[800px] text-center transition-opacity duration-1000 ease-out ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
                data-wow-delay=".2s"
              >
  ...
  <span className="whitespace-nowrap">
    <TextShimmerWave>Frequency</TextShimmerWave>
  </span>
</h1>
        ...
        <div className="absolute bottom-0 left-0 z-[-1] opacity-30 lg:opacity-100">
          ...
          >
            ...
            <circle
              ...
              key={4}
            />
            <circle cx="220" cy="63" r="43" fill="url(#paint5_radial_25:218)" key={5} />
            <defs key={6}>
              <linearGradient
