  ...
  return (
    <>
      <header
        ...
        style={{
          transform: sticky
            ? `translateY(${scrollProgress * 5}px) scale(${
                1 - scrollProgress * 0.1
              })`
            : "none",
          borderRadius: sticky ? `${scrollProgress * 30}px` : "0",
          margin: sticky ? `${scrollProgress * 4}px auto` : "0 auto",
      ...
      >
        <div className="container">
          <div className="relative flex items-center justify-between">
            {/* Logo at far left */}
            <div className="w-40 max-w-full px-2 xl:mr-4 flex-shrink-0">
              <Link
                href="/"
              ...
              >
                <Image
                  src="/images/logo/vectorised_logo.svg"
                  alt="logo"
                  width={140}
                  height={40}
                ...
                />
                <Image
                  src="/images/logo/vectorised_logo_white.svg"
                  alt="logo"
                  width={140}
                  height={40}
            ...
            {/* Right side: theme toggler and mobile menu */}
